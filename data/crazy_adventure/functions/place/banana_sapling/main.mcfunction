	...
	execute unless block ~ ~-1 ~ dirt unless block ~ ~-1 ~ grass_block unless block ~ ~-1 ~ podzol unless block ~ ~-1 ~ coarse_dirt unless block ~ ~-1 ~ rooted_dirt run setblock ~ ~ ~ air

	execute if block ~1 ~ ~ jungle_sapling run loot spawn ~ ~ ~ loot crazy_adventure:i/banana_sapling
	execute if block ~1 ~ ~ jungle_sapling run setblock ~ ~ ~ air
	execute if block ~-1 ~ ~ jungle_sapling run loot spawn ~ ~ ~ loot crazy_adventure:i/banana_sapling
	execute if block ~-1 ~ ~ jungle_sapling run setblock ~ ~ ~ air
	execute if block ~ ~ ~1 jungle_sapling run loot spawn ~ ~ ~ loot crazy_adventure:i/banana_sapling
	execute if block ~ ~ ~1 jungle_sapling run setblock ~ ~ ~ air

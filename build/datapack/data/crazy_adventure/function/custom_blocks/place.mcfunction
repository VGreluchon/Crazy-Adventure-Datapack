...
execute if data storage smithed.custom_block:main blockApi{id:"crazy_adventure:deepslate_uranium_ore"} run function crazy_adventure:custom_blocks/deepslate_uranium_ore/place_main
...
execute if data storage smithed.custom_block:main blockApi{id:"crazy_adventure:banana_plant"} run function crazy_adventure:custom_blocks/banana_plant/place_main

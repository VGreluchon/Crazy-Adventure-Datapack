...
#> crazy_adventure:custom_blocks/californium_block/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:iron_block"}},distance=..1] run function crazy_adventure:custom_blocks/californium_block/replace_item
...
scoreboard players remove #total_californium_block crazy_adventure.data 1

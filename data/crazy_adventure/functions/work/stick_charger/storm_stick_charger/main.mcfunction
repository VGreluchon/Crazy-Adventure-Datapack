...
#Copy Block Item into a storage
	...
	execute if score @s crazy_adventure.charges matches ..9 if block ~ ~1 ~ lightning_rod run function crazy_adventure:work/stick_charger/storm_stick_charger/storm

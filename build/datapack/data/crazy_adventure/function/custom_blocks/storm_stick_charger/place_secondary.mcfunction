...
#> crazy_adventure:custom_blocks/storm_stick_charger/place_secondary
#
# @executed	at @s
#
# @within	crazy_adventure:custom_blocks/storm_stick_charger/place_main [ at @s ]
#
...
tag @s add crazy_adventure.storm_stick_charger
tag @s add crazy_adventure.vanilla.minecraft_furnace

# Add a custom name
data merge entity @s {"CustomName": {"translate": "crazy_adventure.storm_stick_charger"}}

# Modify item display entity to match the custom block
item replace entity @s contents with minecraft:furnace[item_model="crazy_adventure:storm_stick_charger"]

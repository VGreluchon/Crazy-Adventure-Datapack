...
execute store result entity @s Motion[0] double 0.0025 run scoreboard players get #dx crazy_adventure.data
execute store result entity @s Motion[1] double 0.0025 run scoreboard players get #dy crazy_adventure.data
execute store result entity @s Motion[2] double 0.0025 run scoreboard players get #dz crazy_adventure.data

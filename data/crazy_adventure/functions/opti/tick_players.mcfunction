	...
	execute if data entity @s SelectedItem.tag.crazy_adventure.upgrades.ore_finder if score @s crazy_adventure.stone matches 1.. run function crazy_adventure:opti/advancements_rewards/ore_finder

...
#> crazy_adventure:custom_blocks/ore_extractor_4/place_secondary
#
# @executed	at @s
#
# @within	crazy_adventure:custom_blocks/ore_extractor_4/place_main [ at @s ]
#
...
tag @s add crazy_adventure.ore_extractor_4
tag @s add crazy_adventure.vanilla.minecraft_barrel

# Add a custom name
data merge entity @s {"CustomName": {"translate": "crazy_adventure.ore_extractor_4"}}

# Modify item display entity to match the custom block
item replace entity @s contents with minecraft:furnace[item_model="crazy_adventure:ore_extractor_4"]
...
scoreboard players set @s crazy_adventure.energy_rate 300

...
#> crazy_adventure:custom_blocks/nuclear_reactor/place_secondary
#
# @executed	at @s
#
# @within	crazy_adventure:custom_blocks/nuclear_reactor/place_main [ at @s ]
#
...
tag @s add crazy_adventure.nuclear_reactor
tag @s add crazy_adventure.vanilla.minecraft_barrel

# Add a custom name
data merge entity @s {"CustomName": {"translate": "crazy_adventure.nuclear_reactor"}}

# Modify item display entity to match the custom block
item replace entity @s contents with minecraft:furnace[item_model="crazy_adventure:nuclear_reactor"]

...
#Copy Block Item into a storage
	...
	execute if score @s crazy_adventure.charges matches ..9 if block ~ ~1 ~ fire run scoreboard players add @s crazy_adventure.working 5
	execute if score @s crazy_adventure.charges matches ..9 if block ~ ~1 ~ fire run setblock ~ ~1 ~ air
	execute if score @s crazy_adventure.working matches 20.. run particle lava ~ ~ ~ ~1 ~1 ~1 1 20

...
execute if score #temp crazy_adventure.data matches 0 store result score #temp crazy_adventure.data if data storage crazy_adventure:main Inventory[{Slot:103b,tag:{crazy_adventure:{californium_helmet:1b}}}] run tag @s remove crazy_adventure.radiation
execute if score #temp crazy_adventure.data matches 0 store result score #temp crazy_adventure.data if data storage crazy_adventure:main Inventory[{Slot:102b,tag:{crazy_adventure:{californium_chestplate:1b}}}] run tag @s remove crazy_adventure.radiation
execute if score #temp crazy_adventure.data matches 0 store result score #temp crazy_adventure.data if data storage crazy_adventure:main Inventory[{Slot:101b,tag:{crazy_adventure:{californium_leggings:1b}}}] run tag @s remove crazy_adventure.radiation
execute if score #temp crazy_adventure.data matches 0 store result score #temp crazy_adventure.data if data storage crazy_adventure:main Inventory[{Slot:100b,tag:{crazy_adventure:{californium_boots:1b}}}] run tag @s remove crazy_adventure.radiation

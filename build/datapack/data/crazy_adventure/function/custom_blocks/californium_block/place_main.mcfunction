...
#> crazy_adventure:custom_blocks/californium_block/place_main
#
...
execute align xyz positioned ~.5 ~.5 ~.5 summon item_display at @s run function crazy_adventure:custom_blocks/californium_block/place_secondary
...
scoreboard players add #total_californium_block crazy_adventure.data 1

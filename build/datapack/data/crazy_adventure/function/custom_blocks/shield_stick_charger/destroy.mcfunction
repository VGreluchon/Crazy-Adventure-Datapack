...
#> crazy_adventure:custom_blocks/shield_stick_charger/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:furnace"}},distance=..1] run function crazy_adventure:custom_blocks/shield_stick_charger/replace_item
...
scoreboard players remove #total_shield_stick_charger crazy_adventure.data 1

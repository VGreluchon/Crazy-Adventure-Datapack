...
#> crazy_adventure:custom_blocks/uranium_upgrader/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:barrel"}},distance=..1] run function crazy_adventure:custom_blocks/uranium_upgrader/replace_item
...
scoreboard players remove #total_uranium_upgrader crazy_adventure.data 1

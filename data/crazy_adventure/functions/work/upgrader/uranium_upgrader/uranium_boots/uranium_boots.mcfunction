...
scoreboard players set #success crazy_adventure.data 0
#Attack Damage
	execute if score #health crazy_adventure.data matches 1 store success score #success crazy_adventure.data if score #slot crazy_adventure.data matches 6 run data modify block ~ ~ ~ Items[{Slot:19b}].tag.AttributeModifiers append value {AttributeName:"generic.max_health",Name:"generic.max_health",Slot:"feet",Amount:1.0d,Operation:0,UUID:[I;201302,201306,201302,201302]}
...
#Speed
	execute if score #speed crazy_adventure.data matches 1 store success score #success crazy_adventure.data if score #slot crazy_adventure.data matches 24 run data modify block ~ ~ ~ Items[{Slot:19b}].tag.AttributeModifiers append value {AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Slot:"feet",Amount:0.05d,Operation:1,UUID:[I;201302,201316,201302,201302]}

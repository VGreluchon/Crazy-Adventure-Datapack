...
#Others
	...
	execute as @e[tag=crazy_adventure.destroyer,tag=!simplenergy.item_destroy,predicate=!crazy_adventure:check_destroyer] at @s run function crazy_adventure:destroy/all

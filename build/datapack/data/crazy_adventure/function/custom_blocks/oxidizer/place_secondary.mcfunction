...
#> crazy_adventure:custom_blocks/oxidizer/place_secondary
#
# @executed	at @s
#
# @within	crazy_adventure:custom_blocks/oxidizer/place_main [ at @s ]
#
...
tag @s add crazy_adventure.oxidizer
tag @s add crazy_adventure.vanilla.minecraft_barrel

# Add a custom name
data merge entity @s {"CustomName": {"translate": "crazy_adventure.oxidizer"}}

# Modify item display entity to match the custom block
item replace entity @s contents with minecraft:furnace[item_model="crazy_adventure:oxidizer"]

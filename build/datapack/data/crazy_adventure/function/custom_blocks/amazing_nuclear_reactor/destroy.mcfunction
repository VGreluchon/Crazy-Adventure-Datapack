...
#> crazy_adventure:custom_blocks/amazing_nuclear_reactor/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:barrel"}},distance=..1] run function crazy_adventure:custom_blocks/amazing_nuclear_reactor/replace_item
...
scoreboard players remove #total_amazing_nuclear_reactor crazy_adventure.data 1

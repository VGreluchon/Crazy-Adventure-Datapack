...
#> crazy_adventure:custom_blocks/ore_extractor_2/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:barrel"}},distance=..1] run function crazy_adventure:custom_blocks/ore_extractor_2/replace_item
...
scoreboard players remove #total_ore_extractor_2 crazy_adventure.data 1

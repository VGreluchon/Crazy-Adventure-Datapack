...
execute if score @s crazy_adventure.working matches 7 run loot insert ~ ~ ~ loot crazy_adventure:ore_extractor/lvl2
execute if score @s crazy_adventure.working matches 7 run scoreboard players set @s crazy_adventure.working 0

...
execute if score #success crazy_adventure.data matches 0 store success score #success crazy_adventure.data if data storage crazy_adventure:main Item.tag.AttributeModifiers[{Name:"generic.armor",Amount:8.0d}] run scoreboard players set #armor crazy_adventure.data 1
execute if score #success crazy_adventure.data matches 0 store success score #success crazy_adventure.data if data storage crazy_adventure:main Item.tag.AttributeModifiers[{Name:"generic.armor",Amount:9.0d}] run scoreboard players set #armor crazy_adventure.data 2
execute if score #success crazy_adventure.data matches 0 store success score #success crazy_adventure.data if data storage crazy_adventure:main Item.tag.AttributeModifiers[{Name:"generic.armor",Amount:10.0d}] run scoreboard players set #armor crazy_adventure.data 3
#Speed
scoreboard players set #success crazy_adventure.data 0
...
scoreboard players set #success crazy_adventure.data 0
#Attack Damage
	execute if score #health crazy_adventure.data matches 1 store success score #success crazy_adventure.data if score #slot crazy_adventure.data matches 6 run data modify block ~ ~ ~ Items[{Slot:19b}].tag.AttributeModifiers append value {AttributeName:"generic.max_health",Name:"generic.max_health",Slot:"chest",Amount:1.0d,Operation:0,UUID:[I;201302,201304,201302,201302]}
...
#Armor
	execute if score #armor crazy_adventure.data matches 1 store success score #success crazy_adventure.data if score #slot crazy_adventure.data matches 15 run data modify block ~ ~ ~ Items[{Slot:19b}].tag.AttributeModifiers[{Name:"generic.armor"}].Amount set value 9.0d
	...
	execute if score #armor crazy_adventure.data matches 2 store success score #success crazy_adventure.data if score #slot crazy_adventure.data matches 15 run data modify block ~ ~ ~ Items[{Slot:19b}].tag.AttributeModifiers[{Name:"generic.armor"}].Amount set value 10.0d
...
#Speed
	execute if score #speed crazy_adventure.data matches 1 store success score #success crazy_adventure.data if score #slot crazy_adventure.data matches 24 run data modify block ~ ~ ~ Items[{Slot:19b}].tag.AttributeModifiers append value {AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Slot:"chest",Amount:0.05d,Operation:1,UUID:[I;201302,201314,201302,201302]}

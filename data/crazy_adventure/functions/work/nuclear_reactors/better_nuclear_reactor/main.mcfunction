...
execute if score @s crazy_adventure.working matches 1 run function crazy_adventure:work/nuclear_reactors/better_nuclear_reactor/loot_nuclear_reactor
execute if score @s crazy_adventure.working matches 1 if predicate crazy_adventure:nuclear_reactor run function crazy_adventure:work/nuclear_reactors/better_nuclear_reactor/nugget

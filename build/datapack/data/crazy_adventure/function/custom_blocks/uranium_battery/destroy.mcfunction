...
#> crazy_adventure:custom_blocks/uranium_battery/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:emerald_block"}},distance=..1] run function crazy_adventure:custom_blocks/uranium_battery/replace_item
...
scoreboard players remove #total_uranium_battery crazy_adventure.data 1

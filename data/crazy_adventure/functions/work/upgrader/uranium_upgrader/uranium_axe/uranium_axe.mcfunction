...
##Check upgrades
#Second Life
scoreboard players set #second_life crazy_adventure.data 0
execute store success score #second_life crazy_adventure.data if data storage crazy_adventure:main Item.tag.crazy_adventure.upgrades.second_life
#More Radioactivity
...
#Second Life
	execute if score #second_life crazy_adventure.data matches 0 if score #slot crazy_adventure.data matches 6 run data modify block ~ ~ ~ Items[{Slot:19b}].tag.display.Lore prepend value '{"color":"gray","italic":false,"translate": "Second Life I"}'
	execute if score #second_life crazy_adventure.data matches 0 store success score #success crazy_adventure.data if score #slot crazy_adventure.data matches 6 run data modify block ~ ~ ~ Items[{Slot:19b}].tag.crazy_adventure.upgrades.second_life set value 1b
	execute if score #second_life crazy_adventure.data matches 0 run item replace block ~ ~ ~ container.6 with cobblestone{CustomModelData:4221258,simplenergy:{texture_item:1b},display:{Name:'[{"text":"Gain Tool\'s Second Life 0/1","italic":false,"color":"gold"}]'}}
	execute if score #second_life crazy_adventure.data matches 1 run item replace block ~ ~ ~ container.6 with cobblestone{CustomModelData:4221259,simplenergy:{texture_item:1b},display:{Name:'[{"text":"Tool\'s Second Life 1/1","italic":false,"color":"green"}]'}}
#More radioactive

...
execute if score #game_version load.status matches 2975.. if score SimplEnergy load.status matches 1090..1099 run tellraw @a[tag=convention.debug] {"text":"[Loaded Crazy Adventure v1.2.1]","italic":false,"color":"green"}

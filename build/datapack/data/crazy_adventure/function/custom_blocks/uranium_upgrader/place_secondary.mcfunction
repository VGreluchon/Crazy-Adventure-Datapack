...
#> crazy_adventure:custom_blocks/uranium_upgrader/place_secondary
#
# @executed	at @s
#
# @within	crazy_adventure:custom_blocks/uranium_upgrader/place_main [ at @s ]
#
...
tag @s add crazy_adventure.uranium_upgrader
tag @s add crazy_adventure.vanilla.minecraft_barrel

# Add a custom name
data merge entity @s {"CustomName": {"translate": "crazy_adventure.uranium_upgrader"}}

# Modify item display entity to match the custom block
item replace entity @s contents with minecraft:furnace[item_model="crazy_adventure:uranium_upgrader"]
...
scoreboard players set @s crazy_adventure.energy_rate 0

...
#> crazy_adventure:custom_blocks/ore_extractor_1/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:barrel"}},distance=..1] run function crazy_adventure:custom_blocks/ore_extractor_1/replace_item
...
scoreboard players remove #total_ore_extractor_1 crazy_adventure.data 1

# Kill the custom block entity
kill @s

# Decrease the number of entities with second tag
scoreboard players remove #second_entities crazy_adventure.data 1

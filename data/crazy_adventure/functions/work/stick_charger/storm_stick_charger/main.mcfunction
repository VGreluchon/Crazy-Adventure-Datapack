...
#Copy Block Item into a storage
	...
	execute if score @s crazy_adventure.charges matches 10 if data storage crazy_adventure:main Items[{Slot:15b,tag:{crazy_adventure:{storm_stick:1b}}}] if data storage crazy_adventure:main Items[{Slot:11b,tag:{crazy_adventure:{chargeless_stick:1b}}}] run data modify entity @s Item.tag.Enchantments set value [{id:"minecraft:protection",lvl:0}]

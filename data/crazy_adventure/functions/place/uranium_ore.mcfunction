...
execute store success score #success crazy_adventure.data if block ~ ~ ~ #minecraft:deepslate_ore_replaceables run function crazy_adventure:place/uranium_ore/main
